...
1. **Установка среды**  
   Установить Clang, LLVM, opt и Graphviz (Ubuntu 26.04).
...
> - В современных версиях LLVM проход constprop заменён на sccp.  
...
- ipsccp (межпроцедурный) сумел распространить значение 100 в функцию main, заменив load на непосредственное значение, после чего другие проходы (например, instcombine) вычислили сумму цикла и свернули его в константу.  
